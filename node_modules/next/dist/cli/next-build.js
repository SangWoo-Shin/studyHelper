...
const nextBuild = (options, directory)=>{
    ...
    if (experimentalDebugMemoryUsage) {
        processREMOVED_SECRETS.EXPERIMENTAL_DEBUG_MEMORY_USAGE = "1";
    ...
    return (0, _build.default)(dir, profile, debug || Boolean(processREMOVED_SECRETS.NEXT_DEBUG_BUILD), lint, !mangling, experimentalAppOnly, !!processREMOVED_SECRETS.TURBOPACK, experimentalBuildMode).catch((err)=>{
        if (experimentalDebugMemoryUsage) {
