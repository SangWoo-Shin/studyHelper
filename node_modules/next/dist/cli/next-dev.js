...
const nextDev = async (options, portSource, directory)=>{
    dir = (0, _getprojectdir.getProjectDir)(processREMOVED_SECRETS.NEXT_PRIVATE_DEV_DIR || directory);
    ...
    if (options.experimentalUploadTrace && !processREMOVED_SECRETS.NEXT_TRACE_UPLOAD_DISABLED) {
    ...
    if (options.turbo) {
        processREMOVED_SECRETS.TURBOPACK = "1";
    }
    isTurboSession = !!processREMOVED_SECRETS.TURBOPACK;
    ...
    async function startServer(startServerOptions) {
        return new Promise((resolve)=>{
            let resolved = false;
            const defaultEnv = _env.initialEnv || processREMOVED_SECRETS;
            ...
            if (!maxOldSpaceSize && !processREMOVED_SECRETS.NEXT_DISABLE_MEM_OVERRIDE) {
            ...
            child = (0, _child_process.fork)(startServerPath, {
                ...
                env: {
                    ...defaultEnv,
                    TURBOPACK: processREMOVED_SECRETS.TURBOPACK,
