...
function getDocumentFiles(buildManifest, pathname, inAmpMode) {
    ...
    const pageFiles = processREMOVED_SECRETS.NEXT_RUNTIME !== "edge" && inAmpMode ? [] : getPageFiles(buildManifest, pathname);
    return {
        sharedFiles,
        pageFiles,
        allFiles: [
    ...
    render() {
        ...
        return /*#__PURE__*/ _jsxs("head", {
            ...
            children: [
                ...
                processREMOVED_SECRETS.NEXT_RUNTIME !== "edge" && inAmpMode && /*#__PURE__*/ _jsxs(_Fragment, {
                    children: [
                        /*#__PURE__*/ _jsx("meta", {
                            name: "viewport",
