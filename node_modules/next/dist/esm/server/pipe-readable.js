...
function createWriterFromResponse(res, waitUntilForEnd) {
    ...
    return new WritableStream({
        write: async (chunk)=>{
            ...
            if (!started) {
                started = true;
                if ("performance" in globalThis && processREMOVED_SECRETS.NEXT_OTEL_PERFORMANCE_PREFIX) {
                    const metrics = getClientComponentLoaderMetrics();
                    if (metrics) {
                        performance.measure(`${processREMOVED_SECRETS.NEXT_OTEL_PERFORMANCE_PREFIX}:next-client-component-loading`, {
