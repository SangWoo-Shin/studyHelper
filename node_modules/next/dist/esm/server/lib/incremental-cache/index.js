...
export class IncrementalCache {
    constructor({ fs, dev, appDir, pagesDir, flushToDisk, fetchCache, minimalMode, serverDistDir, requestHeaders, requestProtocol, maxMemoryCacheSize, getPrerenderManifest, fetchCacheKeyPrefix, CurCacheHandler, allowedRevalidateHeaderKeys, experimental }){
        ...
        const debug = !!processREMOVED_SECRETS.NEXT_PRIVATE_DEBUG_CACHE;
        ...
        if (processREMOVED_SECRETS.__NEXT_TEST_MAX_ISR_CACHE) {
            // Allow cache size to be overridden for testing purposes
            maxMemoryCacheSize = parseInt(processREMOVED_SECRETS.__NEXT_TEST_MAX_ISR_CACHE, 10);
        }
        this.dev = dev;
        this.disableForTestmode = processREMOVED_SECRETS.NEXT_PRIVATE_TEST_PROXY === "true";
    ...
    async lock(cacheKey) {
        if (processREMOVED_SECRETS.__NEXT_INCREMENTAL_CACHE_IPC_PORT && processREMOVED_SECRETS.__NEXT_INCREMENTAL_CACHE_IPC_KEY && processREMOVED_SECRETS.NEXT_RUNTIME !== "edge") {
            const invokeIpcMethod = require("../server-ipc/request-utils").invokeIpcMethod;
            await invokeIpcMethod({
                method: "lock",
                ipcPort: processREMOVED_SECRETS.__NEXT_INCREMENTAL_CACHE_IPC_PORT,
                ipcKey: processREMOVED_SECRETS.__NEXT_INCREMENTAL_CACHE_IPC_KEY,
                args: [
                    cacheKey
                ]
            });
