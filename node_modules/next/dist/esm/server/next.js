        ...
        if (!this.serverPromise) {
            this.serverPromise = this[SYMBOL_LOAD_CONFIG]().then(async (conf)=>{
                if (this.standaloneMode) {
                    processREMOVED_SECRETS.__NEXT_PRIVATE_STANDALONE_CONFIG = JSON.stringify(conf);
                }
                if (!this.options.dev) {
...
function createServer(options) {
    ...
    if (!("isNextDevCommand" in options) && processREMOVED_SECRETS.NODE_ENV && ![
        "production",
        "development",
        "test"
    ].includes(processREMOVED_SECRETS.NODE_ENV)) {
