...
const isTestMode = !!(processREMOVED_SECRETS.NEXT_TEST_MODE || processREMOVED_SECRETS.__NEXT_TEST_MODE || processREMOVED_SECRETS.DEBUG);
export async function createHotReloaderTurbopack(opts, serverFields, distDir) {
    ...
    if (processREMOVED_SECRETS.TURBOPACK && isTestMode) {
    ...
    const hotReloader = {
        ...
        async invalidate ({ // REMOVED_SECRETS files or tsconfig/jsconfig change
