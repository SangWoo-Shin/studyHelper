...
export default class NextNodeServer extends BaseServer {
   ...
   */ async runMiddleware(params) {
    ...
    getPrerenderManifest() {
        ...
        if (((_this_renderOpts = this.renderOpts) == null ? void 0 : _this_renderOpts.dev) || ((_this_serverOptions = this.serverOptions) == null ? void 0 : _this_serverOptions.dev) || processREMOVED_SECRETS.NODE_ENV === "development" || processREMOVED_SECRETS.NEXT_PHASE === PHASE_PRODUCTION_BUILD) {
