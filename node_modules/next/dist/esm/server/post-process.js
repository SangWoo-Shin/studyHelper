...
async function postProcessHTML(pathname, content, renderOpts, { inAmpMode, hybridAmp }) {
    const postProcessors = [
        processREMOVED_SECRETS.NEXT_RUNTIME !== "edge" && inAmpMode ? async (html)=>{
        ...
        processREMOVED_SECRETS.NEXT_RUNTIME !== "edge" && renderOpts.optimizeFonts ? async (html)=>{
        ...
        processREMOVED_SECRETS.NEXT_RUNTIME !== "edge" && renderOpts.optimizeCss ? async (html)=>{
...
// Initialization
registerPostProcessor("Inline-Fonts", new FontOptimizerMiddleware(), // Using processREMOVED_SECRETS because passing Experimental flag through loader is not possible.
// @ts-ignore
(options)=>options.optimizeFonts || processREMOVED_SECRETS.__NEXT_OPTIMIZE_FONTS);
