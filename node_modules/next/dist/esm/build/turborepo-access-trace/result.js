export class TurborepoAccessTraceResult {
    constructor(envVars = new Set([]), addresses = [], fsPaths = new Set([])){
        thisREMOVED_SECRETSVars = envVars;
   ...
   */ merge(other) {
        otherREMOVED_SECRETSVars.forEach((envVar)=>thisREMOVED_SECRETSVars.add(envVar));
   ...
   */ serialize() {
        return {
            ...
            envVars: Array.from(thisREMOVED_SECRETSVars).map(String)
        };
    }
    /**
   ...
   */ toPublicTrace() {
        return {
            ...
            envVarKeys: Array.from(thisREMOVED_SECRETSVars).map(String),
   ...
   */ static fromSerialized(serialized) {
        return new TurborepoAccessTraceResult(new Set(serializedREMOVED_SECRETSVars), serialized.addresses, new Set(serialized.fs));
    }
}
