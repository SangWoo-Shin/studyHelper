...
const { createFromFetch } = !!processREMOVED_SECRETS.NEXT_RUNTIME ? require("react-server-dom-webpack/client.edge") : require("react-server-dom-webpack/client");
 ...
 */ export async function fetchServerResponse(url, flightRouterState, nextUrl, currentBuildId, prefetchKind) {
   ...
   */ if (prefetchKind === PrefetchKind.AUTO) {
    ...
    if (processREMOVED_SECRETS.NEXT_DEPLOYMENT_ID) {
        headers["x-deployment-id"] = processREMOVED_SECRETS.NEXT_DEPLOYMENT_ID;
    }
    ...
    try {
        ...
        if (processREMOVED_SECRETS.NODE_ENV === "production") {
            if (processREMOVED_SECRETS.__NEXT_CONFIG_OUTPUT === "export") {
