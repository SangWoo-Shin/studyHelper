 ...
 */ const Link = /*#__PURE__*/ React.forwardRef(function LinkComponent(props, forwardedRef) {
    ...
    if (processREMOVED_SECRETS.NODE_ENV !== "production") {
        ...
        // This hook is in a conditional but that is ok because `processREMOVED_SECRETS.NODE_ENV` never changes
    ...
    const childProps = {
        ...
        onMouseEnter (e) {
            ...
            if ((!prefetchEnabled || processREMOVED_SECRETS.NODE_ENV === "development") && isAppRouter) {
                return;
            }
            prefetch(router, href, as, {
                locale,
        ...
        onTouchStart: processREMOVED_SECRETS.__NEXT_LINK_NO_TOUCH_START ? undefined : function onTouchStart(e) {
