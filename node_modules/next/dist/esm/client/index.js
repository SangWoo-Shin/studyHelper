...
class Container extends React.Component {
    ...
    componentDidMount() {
        ...
        if (router.isSsr && (initialData.isFallback || initialData.nextExport && (isDynamicRoute(router.pathname) || location.search || processREMOVED_SECRETS.__NEXT_HAS_REWRITES || initialMatchesMiddleware) || initialData.props && initialData.props.__N_SSG && (location.search || processREMOVED_SECRETS.__NEXT_HAS_REWRITES || initialMatchesMiddleware))) {
...
export async function initialize(opts) {
    ...
    if (processREMOVED_SECRETS.NODE_ENV === "development") {
    ...
    if (processREMOVED_SECRETS.__NEXT_I18N_SUPPORT) {
        ...
        if (initialData.locales) {
            ...
            const detectedDomain = detectDomainLocale(processREMOVED_SECRETS.__NEXT_I18N_DOMAINS, window.location.hostname);
                        ...
                        children: /*#__PURE__*/ _jsx(RouterContext.Provider, {
                            ...
                            children: /*#__PURE__*/ _jsx(HeadManagerContext.Provider, {
                                ...
                                children: /*#__PURE__*/ _jsx(ImageConfigContext.Provider, {
                                    value: processREMOVED_SECRETS.__NEXT_IMAGE_OPTS,
                                    children: children
                                })
                            })
                        })
...
function markHydrateComplete() {
    ...
    if (hasBeforeRenderMark) {
        ...
        if (processREMOVED_SECRETS.NODE_ENV === "development" && // Old versions of Safari don't return `PerformanceMeasure`s from `performance.measure()`
...
function Root(param) {
    ...
    if (processREMOVED_SECRETS.__NEXT_TEST_MODE) {
...
function doRender(input) {
    ...
    function onStart() {
        ...
        processREMOVED_SECRETS.NODE_ENV !== "production") {
            return false;
        }
    ...
    function onHeadCommit() {
        ...
        // unless we're in production:
        processREMOVED_SECRETS.NODE_ENV === "production" && // We can skip this during hydration. Running it wont cause any harm, but
    ...
    renderReactElement(appElement, (callback)=>/*#__PURE__*/ _jsx(Root, {
            ...
            children: processREMOVED_SECRETS.__NEXT_STRICT_MODE ? /*#__PURE__*/ _jsx(React.StrictMode, {
                children: elem
            }) : elem
        }));
...
export async function hydrate(opts) {
    ...
    try {
        ...
        processREMOVED_SECRETS.NODE_ENV === "development" && initialData.err ? {
