...
function getDocumentFiles(buildManifest, pathname, inAmpMode) {
    ...
    const pageFiles = processREMOVED_SECRETS.NEXT_RUNTIME !== "edge" && inAmpMode ? [] : (0, _getpagefiles.getPageFiles)(buildManifest, pathname);
    return {
        sharedFiles,
        pageFiles,
        allFiles: [
...
function getPreNextWorkerScripts(context, props) {
    ...
    if (!nextScriptWorkers || processREMOVED_SECRETS.NEXT_RUNTIME === "edge") return null;
    try {
...
class Head extends _react.default.Component {
    ...
    getCssLinks(files) {
        ...
        if (processREMOVED_SECRETS.NODE_ENV !== "development" && optimizeFonts) {
    ...
    getBeforeInteractiveInlineScripts() {
        ...
        return (scriptLoader.beforeInteractive || []).filter((script)=>!script.src && (script.dangerouslySetInnerHTML || script.children)).map((file, index)=>{
            ...
            return /*#__PURE__*/ (0, _react.createElement)("script", {
                ...
                nonce: nonce,
                "data-nscript": "beforeInteractive",
                crossOrigin: crossOrigin || processREMOVED_SECRETS.__NEXT_CROSS_ORIGIN
            });
        });
    }
    ...
    render() {
        ...
        if (processREMOVED_SECRETS.NODE_ENV !== "development" && optimizeFonts && !(processREMOVED_SECRETS.NEXT_RUNTIME !== "edge" && inAmpMode)) {
        ...
        head = _react.default.Children.map(head || [], (child)=>{
            ...
            if (processREMOVED_SECRETS.NEXT_RUNTIME !== "edge" && inAmpMode) {
                let badProp = "";
        ...
        const files = getDocumentFiles(this.context.buildManifest, this.context.__NEXT_DATA__.page, processREMOVED_SECRETS.NEXT_RUNTIME !== "edge" && inAmpMode);
        ...
        return /*#__PURE__*/ (0, _jsxruntime.jsxs)("head", {
            ...
            children: [
                this.context.isDevelopment && /*#__PURE__*/ (0, _jsxruntime.jsxs)(_jsxruntime.Fragment, {
                    children: [
                        /*#__PURE__*/ (0, _jsxruntime.jsx)("style", {
                            ...
                            "data-ampdevmode": processREMOVED_SECRETS.NEXT_RUNTIME !== "edge" && inAmpMode ? "true" : undefined,
                            dangerouslySetInnerHTML: {
                ...
                processREMOVED_SECRETS.NEXT_RUNTIME !== "edge" && inAmpMode && /*#__PURE__*/ (0, _jsxruntime.jsxs)(_jsxruntime.Fragment, {
                    children: [
...
class NextScript extends _react.default.Component {
    ...
    static getInlineScriptSource(context) {
        ...
        try {
            ...
            const bytes = processREMOVED_SECRETS.NEXT_RUNTIME === "edge" ? new TextEncoder().encode(data).buffer.byteLength : Buffer.from(data).byteLength;
...
function Html(props) {
    ...
    return /*#__PURE__*/ (0, _jsxruntime.jsx)("html", {
        ...
        amp: processREMOVED_SECRETS.NEXT_RUNTIME !== "edge" && inAmpMode ? "" : undefined,
        "data-ampdevmode": processREMOVED_SECRETS.NEXT_RUNTIME !== "edge" && inAmpMode && processREMOVED_SECRETS.NODE_ENV !== "production" ? "" : undefined
    });
}
function Main() {
