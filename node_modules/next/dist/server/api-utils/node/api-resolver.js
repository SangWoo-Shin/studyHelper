 ...
 */ function sendData(req, res, body) {
    ...
    if (res.statusCode === 204 || res.statusCode === 304) {
        ...
        if (processREMOVED_SECRETS.NODE_ENV === "development" && body) {
...
function setDraftMode(res, options) {
    ...
    res.setHeader(`Set-Cookie`, [
        ...
        serialize(_index.COOKIE_NAME_PRERENDER_BYPASS, options.previewModeId, {
            httpOnly: true,
            sameSite: processREMOVED_SECRETS.NODE_ENV !== "development" ? "none" : "lax",
            secure: processREMOVED_SECRETS.NODE_ENV !== "development",
            path: "/",
            expires
        })
    ]);
