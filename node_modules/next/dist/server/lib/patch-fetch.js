...
const isEdgeRuntime = processREMOVED_SECRETS.NEXT_RUNTIME === "edge";
...
function trackFetchMetric(staticGenerationStore, ctx) {
    ...
    if (!staticGenerationStore || ((_staticGenerationStore_requestEndedState = staticGenerationStore.requestEndedState) == null ? void 0 : _staticGenerationStore_requestEndedState.ended) || processREMOVED_SECRETS.NODE_ENV !== "development") {
        return;
    }
...
function createPatchedFetcher(originFetch, { serverHooks: { DynamicServerError }, staticGenerationAsyncStorage }) {
    ...
    const patched = async (input, init)=>{
        ...
        const hideSpan = processREMOVED_SECRETS.NEXT_OTEL_FETCH_DISABLED === "1";
