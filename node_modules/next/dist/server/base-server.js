...
class Server {
    constructor(options){
        ...
        this.handleNextDataRequest = async (req, res, parsedUrl)=>{
            ...
            if (params.path[0] !== this.buildId) {
                ...
                if (processREMOVED_SECRETS.NEXT_RUNTIME !== "edge" && (0, _requestmeta.getRequestMeta)(req, "middlewareInvoke")) {
                    return false;
                }
   ...
   */ this.normalize = (pathname)=>{
        ...
        this.dir = processREMOVED_SECRETS.NEXT_RUNTIME === "edge" ? dir : require("path").resolve(dir);
        this.quiet = quiet;
        this.loadEnvConfig({
            dev
        });
        ...
        this.port = port;
        this.distDir = processREMOVED_SECRETS.NEXT_RUNTIME === "edge" ? this.nextConfig.distDir : require("path").join(this.dir, this.nextConfig.distDir);
        ...
        this[minimalModeKey] = minimalMode || !!processREMOVED_SECRETS.NEXT_PRIVATE_MINIMAL_MODE;
        ...
        if (processREMOVED_SECRETS.NEXT_RUNTIME !== "edge") {
    ...
    async handleRequestImpl(req, res, parsedUrl) {
        try {
            ...
            const useInvokePath = !useMatchedPathHeader && processREMOVED_SECRETS.NEXT_RUNTIME !== "edge" && invokePath;
            if (useInvokePath) {
   ...
   */ async prepare() {
     ...
     */ const isPrefetchRSCRequest = (req.headers[_approuterheaders.NEXT_ROUTER_PREFETCH_HEADER.toLowerCase()] === "1" || (0, _requestmeta.getRequestMeta)(req, "isPrefetchRSCRequest")) ?? false;
            ...
            if (routeModule) {
                if ((0, _checks.isAppRouteRouteModule)(routeModule)) {
                    ...
                    try {
                        ...
                        // as it's not edge.
                        if (isSSG && processREMOVED_SECRETS.NEXT_RUNTIME !== "edge") {
        ...
        const cacheEntry = await this.responseCache.get(ssgCacheKey, async (hasResolved, previousCacheEntry, isRevalidating)=>{
            ...
            //
            if (processREMOVED_SECRETS.NEXT_RUNTIME !== "edge" && !this.minimalMode && fallbackMode !== "blocking" && staticPathKey && !didRespond && !isPreviewMode && isDynamic && (isProduction || !staticPaths || !isPageIncludedInStaticPaths)) {
    ...
    async renderToResponseImpl(ctx) {
        ...
        try {
            ...
            if (!isWrappedError) {
                if (this.minimalMode && processREMOVED_SECRETS.NEXT_RUNTIME !== "edge" || this.renderOpts.dev) {
    ...
    async renderErrorToResponseImpl(ctx, err) {
        ...
        try {
            ...
            if (processREMOVED_SECRETS.NODE_ENV !== "production" && !using404Page && await this.hasPage("/_error") && !await this.hasPage("/404")) {
