...
const isDev = processREMOVED_SECRETS.NODE_ENV === "development";
...
function requirePage(page, distDir, isAppPath) {
    ...
    try {
        processREMOVED_SECRETS.__NEXT_PRIVATE_RUNTIME_TYPE = isAppPath ? "app" : "pages";
        const mod = processREMOVED_SECRETS.NEXT_MINIMAL ? __non_webpack_require__(pagePath) : require(pagePath);
        return mod;
    } finally{
        processREMOVED_SECRETS.__NEXT_PRIVATE_RUNTIME_TYPE = "";
    }
}
