...
let sharp;
try {
    sharp = require(processREMOVED_SECRETS.NEXT_SHARP_PATH || "sharp");
    if (sharp && sharp.concurrency() > 1) {
        // Reducing concurrency should reduce the memory usage too.
        // We more aggressively reduce in dev but also reduce in prod.
        // https://sharp.pixelplumbing.com/api-utility#concurrency
        const divisor = processREMOVED_SECRETS.NODE_ENV === "development" ? 4 : 2;
...
let showSharpMissingWarning = processREMOVED_SECRETS.NODE_ENV === "production";
