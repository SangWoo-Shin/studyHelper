...
async function renderToHTMLImpl(req, res, pathname, query, renderOpts, extra) {
    ...
    let previewData;
    if ((isSSG || getServerSideProps) && !isFallback && processREMOVED_SECRETS.NEXT_RUNTIME !== "edge" && previewProps) {
    ...
    const inAmpMode = processREMOVED_SECRETS.NEXT_RUNTIME !== "edge" && (0, _ampmode.isInAmpMode)(ampState);
    ...
    !getServerSideProps && processREMOVED_SECRETS.NODE_ENV !== "production" && Object.keys((props == null ? void 0 : props.pageProps) || {}).includes("url")) {
    ...
    const renderDocument = async ()=>{
        ...
        if (processREMOVED_SECRETS.NEXT_RUNTIME === "edge" && Document.getInitialProps) {
        ...
        const hasDocumentGetInitialProps = !(processREMOVED_SECRETS.NEXT_RUNTIME === "edge" || !Document.getInitialProps);
        let bodyResult;
    ...
    const htmlProps = {
        ...
        unstable_runtimeJS: processREMOVED_SECRETS.NODE_ENV === "production" ? pageConfig.unstable_runtimeJS : undefined,
