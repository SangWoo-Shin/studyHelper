...
async function ReactServerError({ tree, ctx, errorType }) {
    ...
    const head = /*#__PURE__*/ (0, _jsxruntime.jsxs)(_jsxruntime.Fragment, {
        children: [
            ...
            /*#__PURE__*/ (0, _jsxruntime.jsx)(MetadataTree, {}, requestId),
            processREMOVED_SECRETS.NODE_ENV === "development" && /*#__PURE__*/ (0, _jsxruntime.jsx)("meta", {
                name: "next-error",
                content: "not-found"
            })
        ]
...
async function renderToHTMLOrFlightImpl(req, res, pagePath, query, renderOpts, baseCtx, requestEndedState) {
   ...
   */ const generateStaticHTML = supportsDynamicHTML !== true;
    ...
    if (enableTainting) {
        taintObjectReference("Do not pass processREMOVED_SECRETS to client components since it will leak sensitive data", processREMOVED_SECRETS);
    }
        ...
        try {
           ...
           */ // First we check if we have any dynamic holes in our HTML prerender
            ...
            try {
                ...
                if (processREMOVED_SECRETS.NODE_ENV === "development" && (0, _notfound.isNotFoundError)(finalErr)) {
