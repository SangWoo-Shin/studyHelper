...
function getOrCreatePrefetchCacheEntry(param) {
    ...
    return createLazyPrefetchEntry({
        ...
        (processREMOVED_SECRETS.NODE_ENV === "development" ? _routerreducertypes.PrefetchKind.AUTO : _routerreducertypes.PrefetchKind.TEMPORARY)
    });
}
/*
...
const DYNAMIC_STALETIME_MS = Number(processREMOVED_SECRETS.__NEXT_CLIENT_ROUTER_DYNAMIC_STALETIME) * 1000;
const STATIC_STALETIME_MS = Number(processREMOVED_SECRETS.__NEXT_CLIENT_ROUTER_STATIC_STALETIME) * 1000;
