...
const { createFromFetch, encodeReply } = !!processREMOVED_SECRETS.NEXT_RUNTIME ? require("react-server-dom-webpack/client.edge") : require("react-server-dom-webpack/client");
async function fetchServerAction(state, nextUrl, param) {
    ...
    const res = await fetch("", {
        ...
        headers: {
            ...
            ...processREMOVED_SECRETS.NEXT_DEPLOYMENT_ID ? {
                "x-deployment-id": processREMOVED_SECRETS.NEXT_DEPLOYMENT_ID
            } : {},
            ...nextUrl ? {
