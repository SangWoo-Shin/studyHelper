...
const StrictModeIfEnabled = processREMOVED_SECRETS.__NEXT_STRICT_MODE_APP ? _react.default.StrictMode : _react.default.Fragment;
function Root(param) {
    let { children } = param;
...
function hydrate() {
    ...
    if (isError) {
        if (processREMOVED_SECRETS.NODE_ENV !== "production") {
            ...
            const socketUrl = getSocketUrl(processREMOVED_SECRETS.__NEXT_ASSET_PREFIX || "");
