    ...
    return _staticgenerationasyncstoragewrapper.StaticGenerationAsyncStorageWrapper.wrap(ComponentMod.staticGenerationAsyncStorage, {
        ...
        if (typeof (pageEntry == null ? void 0 : pageEntry.getStaticPaths) === "function") {
            ...
            if (!hadAllParamsGenerated) {
                return {
                    paths: undefined,
                    fallback: processREMOVED_SECRETS.NODE_ENV === "production" && (0, _isdynamic.isDynamicRoute)(page) ? true : undefined,
...
const currentPort = parseInt(processREMOVED_SECRETS.PORT, 10) || 3000
const hostname = processREMOVED_SECRETS.HOSTNAME || '0.0.0.0'

let keepAliveTimeout = parseInt(processREMOVED_SECRETS.KEEP_ALIVE_TIMEOUT, 10)
const nextConfig = ${JSON.stringify(nextConfig)}

processREMOVED_SECRETS.__NEXT_PRIVATE_STANDALONE_CONFIG = JSON.stringify(nextConfig)
