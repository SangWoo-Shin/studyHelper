...
function createRequest(model, bundlerConfig, onError, identifierPrefix, onPostpone, environmentName) {
  ...
  {
    requestREMOVED_SECRETSironmentName = environmentName === undefined ? 'Server' : environmentName;
  }
...

  {
    if (debugID === null) {
      ...
      emitDebugChunk(request, debugID, {
        name: componentName,
        env: requestREMOVED_SECRETSironmentName
      });
    }
  }
...
function emitConsoleChunk(request, id, methodName, stackTrace, args) {
  ...
  var env = requestREMOVED_SECRETSironmentName;
...
function renderToReadableStream(model, turbopackMap, options) {
  var request = createRequest(model, turbopackMap, options ? options.onError : undefined, options ? options.identifierPrefix : undefined, options ? options.onPostpone : undefined, options ? optionsREMOVED_SECRETSironmentName : undefined);
