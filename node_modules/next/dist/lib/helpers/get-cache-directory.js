...
function getCacheDirectory(fileDirectory, envPath) {
    ...
    if (envPath) {
        ...
        if (process.platform === "linux") {
            systemCacheDirectory = processREMOVED_SECRETS.XDG_CACHE_HOME || _path.default.join(_os.default.homedir(), ".cache");
        } else if (process.platform === "darwin") {
            systemCacheDirectory = _path.default.join(_os.default.homedir(), "Library", "Caches");
        } else if (process.platform === "win32") {
            systemCacheDirectory = processREMOVED_SECRETS.LOCALAPPDATA || _path.default.join(_os.default.homedir(), "AppData", "Local");
        } else {
    ...
    if (!_path.default.isAbsolute(result)) {
        ...
        result = _path.default.resolve(processREMOVED_SECRETS["INIT_CWD"] || process.cwd(), result);
    }
    return result;
}
